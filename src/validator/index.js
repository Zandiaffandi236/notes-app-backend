...
const { ImageHeaderSchema } = require('./uploads/schema');
...
module.exports = { NoteValidator, UserValidator, AuthenticationValidator, CollaborationValidator, ExportNoteValidator, UploadValidator };